...
function toggleMenu() {
  ...
  if (menuShown) {
    ...
    menuimg.src = "../svg/luk.svg"; // sæt btn.textContent til "Luk", hvis menuShown er "true"
  } else {
    console.log(menuShown); // se i konsollen
    menuimg.src = "../svg/burgermenu.svg"; // sæt btn.textContent til "Menu", hvis menuShown er "false"
  }
